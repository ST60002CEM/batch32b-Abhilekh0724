...
class _DashboardViewState extends ConsumerState<DashboardView> {
  ...
  int _shakeThreshold = 40; // Increase the threshold to make it less sensitive
  bool _canDetectShake = true; // To debounce shake detection
  Duration debounceDuration = const Duration(seconds: 2); // Debounce duration
